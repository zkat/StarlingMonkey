...
} bindings_tuple2_field_key_field_value_t;

typedef struct {
  bindings_tuple2_field_key_field_value_t *ptr;
  size_t len;
...
extern void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, bindings_list_field_value_t *ret);
...
// which have multiple values are represented by multiple entries in this
// list with the same key.
extern void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, bindings_list_tuple2_field_key_field_value_t *ret);
...
void bindings_tuple2_field_key_field_value_free(bindings_tuple2_field_key_field_value_t *ptr);

void bindings_list_tuple2_field_key_field_value_free(bindings_list_tuple2_field_key_field_value_t *ptr);
